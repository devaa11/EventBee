import 'package:event_application1/widget/trendingeventslider.dart';
import 'package:flutter/material.dart';

class categoryslider extends StatefulWidget {
  @override
  _categoryslider createState() => _categoryslider();
}

class _categoryslider extends State<categoryslider> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        TrendingEventsSlider(selectedCategoryIndex: selectedCategoryIndex, categories: categories,),
      ],
    );
  }
}
